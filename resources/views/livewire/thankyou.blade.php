...
<div x-data="{
    ...
    <div class="w-full max-w-md  rounded-2xl shadow-2xl p-10 text-center transition duration-300" x-transition>
        ...
        <h1 class="text-3xl font-bold text-green-600 dark:text-green-400 mb-3">
            Thank You!
        </h1>

        <p class="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8">
            Your booking has been
            <span class="font-semibold">successfully confirmed.</span><br>
            Redirecting in
